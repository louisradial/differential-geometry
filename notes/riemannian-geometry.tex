...
\input{chapter04/s1-group-actions}
\input{chapter04/s2-principal-fiber-bundles}
\input{chapter04/s3-associated-bundles}
\input{chapter04/s4-connections}
\input{chapter04/s5-local-representation-connection}
\input{chapter04/s6-parallel-transport}
\input{chapter04/s7-curvature-torsion}
